<!--
     ...
     - Modificado pelo Jonhatam dia 22/11/18 (Desabilitado o botão excluir da listagem)
...
<div class="float-md-right" style="margin-right: 25px;">
	<label>NOVO</label>
	<button type="button" id="btn-add-3" class="btn btn-primary" data-toggle="modal" data-target="#itemModal"><i class="fa fa-plus-circle"></i></button>
</div>
<br><br><br>
