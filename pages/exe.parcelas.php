...
<form style="margin-top: 30px;">
  <div class="form-group col-md-6">
    ...
    <small id="emailHelp" class="form-text text-muted">informe a descrição do débito.</small>
  </div>
  ...
  <div class="form-group col-md-4">
    <label for="exampleInputPassword1">Número de parcelas</label>
    <input type="number" class="form-control" id="nParcelas" placeholder="Valor">
  </div>
